...
function Mac() {
    ...
    const chickenCards = [
        ...
        [chicken, 'Чикенбургер', 'Обжаренная куриная котлета, панированная в сухарях, которая подается на карамелизованной булочке, заправленной свежим салатом и соусом Ранч.', 4.30],
    ...
    const snacks = [
        [free, 'КАРТОФЕЛЬ ФРИ', 'Хрустящие, золотистые, обжаренные в растительном фритюре и слегка посоленные соломки отборного картофеля.', 5.50],
        [country, 'КАРТОФЕЛЬ ПО-ДЕРЕВЕНСКИ', 'Вкусные, обжаренные в растительном фритюре ломтики картофеля со специями.', 5.70]
    ]
