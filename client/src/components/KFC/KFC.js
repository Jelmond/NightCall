...
function KFC() {
    ...
    const chicken = [
        [five, '5 крыльев', 'Огонь внутри! Далеко не ангельские крылья! Наши острые куриные крылья в хрустящей панировке со жгучими специями – настоящий огонь!', 11.50, true],
        [three, ' 5 стрипсов', 'Потрясающе нежное куриное филе мы панируем вручную и готовим в ресторане по уникальному рецепту Полковника Сандерса.', 9.70, true],
        [forStripes, '4 ножки', 'Kуриные ножки с оригинальным вкусом, приготовленные по секретному рецепту Полковника Сандерса «11 трав и специй».', 11.60, true],
    ...
    const snacks = [
        [sandersFree, 'САНДЕРС КАРТОФЕЛЬ ФРИ СТАНДАРТНЫЙ', 'Всеми любимый картофель фри с золотистой корочкой в аккомпанементе фирменного соуса и хрустящего жареного лука.', 6.60],
        [sandersCountry, 'САНДЕРС КАРТОФЕЛЬ ПО-ДЕРЕВЕНСКИ СТАНДАРТНЫЙ', 'Любимый картофель по-деревенски в аккомпанементе фирменного соуса и хрустящего жареного лука.', 6.60],
        [free, 'КАРТОФЕЛЬ ФРИ СТАНДАРТНЫЙ', 'Хрустящая корочка и мягкая и рассыпчатая серединка. В наших ломтиках мы сохранили еще больше вкуса твоего любимого картофеля.', 6.10],
        [country, 'КАРТОФЕЛЬ ПО-ДЕРЕВЕНСКИ СТАНДАРТНЫЙ', 'Рассыпчатый и хрустящий картофель по-деревенски – любимый вкус теперь в KFC!', 6.10]
    ]
