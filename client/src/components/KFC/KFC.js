...
function KFC() {
    ...
    const snacks = [
        ...
        [country, 'КАРТОФЕЛЬ ФРИ СТАНДАРТНЫЙ', 'Хрустящая корочка и мягкая и рассыпчатая серединка. В наших ломтиках мы сохранили еще больше вкуса твоего любимого картофеля.', 6.10, false, 'Kfree3'],
        [free, 'КАРТОФЕЛЬ ПО-ДЕРЕВЕНСКИ СТАНДАРТНЫЙ', 'Рассыпчатый и хрустящий картофель по-деревенски – любимый вкус теперь в KFC!', 6.10, false, 'Kfree4']
    ]
